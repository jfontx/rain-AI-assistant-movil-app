...
import { Wallet, ArrowDownCircle, ArrowUpCircle, Target } from 'lucide-react-native';
...
export default function FinanzasScreen() {
  ...
  const guardarTransaccion = async () => {
    if (!form.monto || !form.descripcion) {
      Alert.alert('Campos requeridos', 'Monto y descripción son obligatorios');
      return;
    }
    try {
      ...
      setForm({ tipo: 'gasto', monto: '', categoria: 'alimentación', descripcion: '', comercio: '' });
      cargarDatos();
    } catch {
